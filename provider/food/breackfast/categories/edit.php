...
$res = imageUpload("../../../../image_home_breackfast",'categories_image');
if ($res == "fail") {
    $data=array("categories_name"=>$categories_name);
}else{
    deleteFile("../../../../image_home_breackfast",$imageold);
    $data = array(
...
updateData("categories_breakfast", $data, "categories_id = '$categories_id'");
